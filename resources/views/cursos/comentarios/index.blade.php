        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="wrap-base fix-w mt-5">
                    ...
                    <p class="info-seccion-aux">Desde esta sección podrás visualizar los comentarios de la clase <strong>{{$curso->name}}</strong>.</p>
                    <form action="">
                                            ...
                                            <tbody>
                                              @foreach($curso->comentarios as $comentario)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ URL::action('CursoController@cambiarEstado', $comentario->id) }}" class="btn btn-success text-white">
