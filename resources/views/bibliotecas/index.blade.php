        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="wrap-base fix-w mt-5">
                    <h6 class="info-sec-tit mt-3">Listado de bibliotecas</h6>
                                ...
                                <table id="table" class="table table-striped table-hover align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ URL::action('BibliotecaController@edit', $biblioteca->id) }}" class="btn btn-info text-white btn-editar">
                                                    <i class="cil-pencil"></i>
                                                </a>
                                                <a class="btn btn-danger text-white btn-eliminar" onclick="eliminarSweet({{$biblioteca->id}})">
                                                    <i class="cil-trash"></i>
                                                </a>
                                                <form id="{{$biblioteca->id}}" action="{{ URL::action('BibliotecaController@destroy', $biblioteca->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
