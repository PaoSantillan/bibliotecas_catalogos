        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="wrap-base fix-w mt-5">
                    ...
                    <form method="POST" action="{{ route('storeContenido') }}" enctype="multipart/form-data"  class="mt-4 aprobar-form">
                    @csrf
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <!--<div class="row">
                                ...
                                <label for="descripCurso" class="form-label">Subir archivo</label>
