        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="wrap-base fix-w mt-5">
                    <h6 class="titulo-seccion"><i class="cil-video"></i> Edición de clases</h6>
                    ...
                    <form method="POST" action="{{ URL::action('ClaseController@update', $clase->id) }}" class="mt-4 aprobar-form">
                    @csrf
                    @method('PUT')
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="link" id="linkclase" value="{{$clase->link}}"  placeholder="https://www... " aria-describedby="linkclaseHelp" required>
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" id="nombreclase" value="{{$clase->name}}" placeholder="Video sobre..." aria-describedby="nombreclaseHelp" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control form-select" name="course_id" id="disponibleen" aria-label="Default select example" required>
                                        @foreach($cursos as $curso)
                                            <option value="{{$curso->id}}" {{ ( $curso->id == $clase->course_id) ? 'selected' : '' }}>{{$curso->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <textarea id="textarea" rows="3" class="form-control" name="description" id="descripurl" placeholder="Describe las características del enlace externo..." aria-describedby="descripurlHelp">{{$clase->description}}</textarea>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12 mt-4">
                                <button type="submit" class="btn btn-primary btn-celeste-dash">Guardar clase</button>
                            </div>
                        </div>
                    </form>
                </div>
