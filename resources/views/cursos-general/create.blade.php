        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="wrap-base fix-w mt-5">
                    <h6 class="titulo-seccion"><i class="cil-briefcase"></i> Crear promocional</h6>
                    <h6 class="info-sec-tit mt-3">Mi nuevo promocional</h6>
                    <form method="POST" action="{{ route('storeCursoGeneral') }}" enctype="multipart/form-data" class="mt-4 aprobar-form">
                    @csrf
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    <label for="nombreCurso" class="form-label">Nombre del promocional</label>
                                    <input type="text" class="form-control" name="name" id="nombreCurso" placeholder="Elige un nombre que represente el promocional..." aria-describedby="nombrecursolHelp" required>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="institucion" id="nombreCurso" placeholder="Ingresa el nombre de la institución..." aria-describedby="nombrecursolHelp" >
                                    <div id="nombrecursolHelp" class="form-text">Puedes usar letras (A - Z) y números (0 - 9).</div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="code" id="nombreCurso" placeholder="Ingresa el código correspondiente..." aria-describedby="nombrecursolHelp" >
                                    <div id="nombrecursolHelp" class="form-text">Puedes usar letras (A - Z) y números (0 - 9).</div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mt-3 mb-3">
                                    ...
                                    <textarea id="textarea" rows="3" class="form-control" name="description" id="descripCurso" placeholder="Describe las características del curso..." aria-describedby="descripCursoHelp"></textarea>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-6">
                                <div class="mt-3 mb-3">
                                    ...
                                    <textarea id="textarea" rows="3" class="form-control" name="user_description" id="descripCurso" placeholder="Esta información se muestra en el inicio..." aria-describedby="descripCursoHelp"></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" name="price_1" id="precio" aria-describedby="precioHelp" name="ingresosTutor" required>
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text">$</span>
                                        <input type="number" class="form-control" name="price_2" id="precio" aria-describedby="precioHelp" name="ingresosTutor" required>
                                        <span class="input-group-text">.00</span>
                                    </div>
                                </div>
                            </div>
